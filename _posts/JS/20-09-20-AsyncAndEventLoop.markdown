...
**동기와 비동기**는 프로그래밍 코드의 <u>작업 처리 방식</u>, 특히 <u>데이터 통신</u>을 처리하는 방식을 설명할 때 중요하게 언급되는 개념입니다. 각 방식은 장단점이 있어 항상 어느 쪽이 좋다라고 말할 수 없습니다. 상황에 적절한 처리 방식으로 코드를 작성 할 수 있어야 합니다.
